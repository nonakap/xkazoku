...
// IHKDEF : キーボード拡張－デフォルト番号の設定 (T.Yui)
...
// IHKINIT : キーボード拡張－移動先データ設定の初期化 (T.Yui)
